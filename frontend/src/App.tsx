          ...
          <div className="bg-ide-sidebar border border-ide-border p-6 rounded-lg w-96 shadow-2xl">
            ...
            <div className="flex justify-end gap-2">
              <button
                ...
                className="px-4 py-2 text-sm text-ide-dim hover:text-ide-text"
              >
                Cancel
              </button>
              <button
      ...
      {modalType === 'clone' && (
        <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center">
          <div className="bg-ide-sidebar border border-ide-border p-6 rounded-lg w-96 shadow-2xl">
            ...
            <p className="text-sm text-ide-dim mb-4">
              Enter a public git URL. This will clear your current workspace.
            </p>
            <input
              type="text"
        ...
        <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center">
          <div className="bg-ide-sidebar border border-ide-border p-6 rounded-lg w-80 shadow-2xl">
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={() => setIsSettingsOpen(false)} className="text-ide-text">
                <X size={18} />
              </button>
            </div>
