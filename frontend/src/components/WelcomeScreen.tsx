    ...
    <div className="h-full w-full bg-ide-bg text-ide-text overflow-y-auto p-10 flex flex-col items-center">
      <div className="max-w-3xl w-full">
        ...
        <p className="text-lg text-ide-dim mb-8">
          Your secure, cloud-native development environment is ready. Use the terminal below to
          access pre-installed AI tools.
        </p>
          ...
          <div className="bg-ide-sidebar p-5 rounded-lg border border-ide-border">
            ...
            <ul className="space-y-2 text-sm text-ide-dim">
              <li className="flex gap-2">
                <code className="bg-ide-activity px-1 rounded text-ide-text">gemini</code> Google
                Gemini CLI
              </li>
              <li className="flex gap-2">
                <code className="bg-ide-activity px-1 rounded text-ide-text">opencode</code>{' '}
                OpenCode Assistant
              </li>
              <li className="flex gap-2">
                <code className="bg-ide-activity px-1 rounded text-ide-text">claude</code> Claude
                Code CLI
              </li>
              <li className="flex gap-2">
                <code className="bg-ide-activity px-1 rounded text-ide-text">codex</code> OpenAI
                Codex
              </li>
            </ul>
          </div>
